...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        generisiTacke = new QPushButton(Widget);
        generisiTacke->setObjectName(QStringLiteral("generisiTacke"));
        generisiTacke->setStyleSheet(QStringLiteral("background-color: rgb(167, 167, 167)"));

        horizontalLayout->addWidget(generisiTacke);
        ...
        pauzaNastavak = new QPushButton(Widget);
        pauzaNastavak->setObjectName(QStringLiteral("pauzaNastavak"));
        pauzaNastavak->setStyleSheet(QStringLiteral("background-color: rgb(167, 167, 167)"));

        horizontalLayout->addWidget(pauzaNastavak);

        stop = new QPushButton(Widget);
        stop->setObjectName(QStringLiteral("stop"));
        stop->setStyleSheet(QStringLiteral("background-color: rgb(167, 167, 167)"));
        ...
        obrisiSve = new QPushButton(Widget);
        obrisiSve->setObjectName(QStringLiteral("obrisiSve"));
        obrisiSve->setStyleSheet(QStringLiteral("background-color: rgb(167, 167, 167)"));

        horizontalLayout->addWidget(obrisiSve);
    ...
    {
        Widget->setWindowTitle(QApplication::translate("Widget", "Konveksni omota\304\215", Q_NULLPTR));
        label_2->setText(QApplication::translate("Widget", "Broj ta\304\215aka", Q_NULLPTR));
        generisiTacke->setText(QApplication::translate("Widget", "Generi\305\241i proizvoljne ta\304\215ke", Q_NULLPTR));
        ...
        pauzaNastavak->setText(QApplication::translate("Widget", "Pauza", Q_NULLPTR));
        ...
        obrisiSve->setText(QApplication::translate("Widget", "Obri\305\241i sve", Q_NULLPTR));
